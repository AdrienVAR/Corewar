...
/*   Updated: 2019/09/09 17:33:08 by cgiron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "arena.h"

static void		command_comp_and(t_process *process, t_command command, char *arena)
{
	t_dir_cast	comp[3];
	int			reg_dst;
	int			dec;
...
void			ex_command_and(t_process *process, char *arena)
{
	...
	command_comp_and(process, command, arena);
}
