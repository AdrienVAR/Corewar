...
/*   Updated: 2019/09/10 14:59:44 by cgiron           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	{"live", 1, {T_DIR}, 1, 10, "alive", 0, DIR_SIZE, 0},
	{"ld", 2, {T_DIR | T_IND, T_REG}, 2, 5, "load", 1, DIR_SIZE, 1},
	{"st", 2, {T_REG, T_IND | T_REG}, 3, 5, "store", 1, DIR_SIZE, 0},
	...
	{"zjmp", 1, {T_DIR}, 9, 20, "jump if zero", 0, IND_SIZE, 2},
	{"ldi", 3, {T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG}, 10, 25,
		"load index", 1, IND_SIZE, 1},
	{"sti", 3, {T_REG, T_REG | T_DIR | T_IND, T_DIR | T_REG}, 11, 25,
		"store index", 1, IND_SIZE, 0},
	{"fork", 1, {T_DIR}, 12, 800, "fork", 0, IND_SIZE, 0},
	{"lld", 2, {T_DIR | T_IND, T_REG}, 13, 10, "long load", 1, 0, 1},
	{"lldi", 3, {T_REG | T_DIR | T_IND, T_DIR | T_REG, T_REG}, 14, 50,
		"long load index", 1, IND_SIZE, 1},
	{"lfork", 1, {T_DIR}, 15, 1000, "long fork", 0, IND_SIZE, 0},
	{"aff", 1, {T_REG}, 16, 2, "aff", 1, DIR_SIZE, 0},
